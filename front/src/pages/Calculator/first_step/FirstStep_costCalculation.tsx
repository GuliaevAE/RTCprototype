...
const FirstStep_card_costCalculation = () => {
    ...
    const addORupdateFunction = () => {
        ...
        const costArray = [
            ...
            комиссия, средняяЦена, ценаОриентир, Number(вес) ? Number(цена_юани_от) > 0 ? цена_юани_от : 'не подходит' : '*вес', "", себестоимость_от, "", вес, расчетВеса_добор15, объем, плотность, ставка_кг_м3, вРублях, ставка_едТовара, страховка_доставка_от, "", стоимостьУпаковки, доставка_ед_от, "", стоимость_от, "", Курс_доллар, Курс_юань, Курс_юань_надбавка, Курс_доллар_16
        ]
        const rentArray = [
            originalStaf.imt_name, '', originalStaf.nm_id, средняяЦена, ценаЗакупа, комиссия, Длинна, Ширина, Высота, объем, СреднийТарифЛогистики, ЛогистикаотОбъема, ЛогистикаНа1Заказ_абсолют, ЛогистикаНа1Заказ_проценты, хранение, товар, налоги, брак, Упаковка, УпаковкаПлюсМашина
        ]
        if (itemId) {
