...
const FirstStep_card_costCalculation = () => {
    ...
    const addORupdateFunction = () => {
        ...
        const costArray = [
            ...
            комиссия, средняяЦена, ценаОриентир, Number(вес) ? Number(цена_юани_от) > 0 ? null : 'не подходит' : '*вес', "", null, null, вес, null, объем, null, ставка_кг_м3, вРублях, ставка_едТовара, null, null, стоимостьУпаковки, null, null, null, null, Курс_доллар, Курс_юань, Курс_юань_надбавка, Курс_доллар_16
        ]
        const rentArray = [
