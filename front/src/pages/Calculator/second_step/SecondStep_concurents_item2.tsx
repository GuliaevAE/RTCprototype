...
// const SecondStep_concurents_item2 = ({ conc }: { conc: TConcurent }) => {
...
//                 <div className='cube_right'><span>sdaskjndkjasn</span></div>
...
// export default SecondStep_concurents_item2;